        ...
        function magic()
        {
          if (simsubscreennum===1)
          {
            ...
            animateArrowATPosition(60,78,20,270);
          ...
          if (simsubscreennum===3)
          {
            ...
            document.getElementById('ok').onclick = function() {
              ...
              myInt = setInterval(function(){ animatearrow(); }, 500);
              animateArrowATPosition(300,180,25,-90);
          ...
          if (simsubscreennum===7)
          {
            ...
            document.getElementById('slider_1').onclick=function() { stepp1(); };
          }
          ...
          if (simsubscreennum===8)
          {
            ...
            display('click_1','circle_2','circle_2','speed_1','ndswh_1','arrow2','wind','can-1','can-2','can-3','n-1');
        ...
        function step1_11()
        {
          ...
          document.getElementById('m12').style.visibility="visible";
            ...
            {
            myInt = setInterval(function(){ animatearrow(); }, 500);
            animateArrowATPosition(185,260,20,720);
        ...
        {
          myStopFunction();
          document.getElementById('slider_1').onclick="";
          document.getElementById("slider_1").style.animation = "mover 1s ease-in-out forwards";
          setTimeout(function()
          {
            document.getElementById('click_1').style.visibility = "visible";
            myInt = setInterval(function(){ animatearrow(); }, 500);
            animateArrowATPosition(198,280,20,720);
          },1000);
          document.getElementById("circle_1").onclick=function() {stepp1_11();};
        }
        ...
        {
          myStopFunction();
          document.getElementById("circle_1").onclick="";
            var rt1 = 200;
          ...
          setTimeout(function()
          {
            myInt = setInterval(function(){ animatearrow(); }, 500);
            animateArrowATPosition(720,360,20,720);
            document.getElementById("venti_cap_1").onclick=function() {
              myStopFunction();
              this.onclick = null;
            ...
            document.getElementById("circle_3").onclick=function() {
              myStopFunction();
              this.onclick = null;
              ...
              document.getElementById("speed1_1").onclick=function() {
              myStopFunction();
              this.onclick = null;

              document.getElementById('speed_1').style.visibility="visible";
              document.getElementById('ndswh_1').style.visibility="visible";
              document.getElementById("ndswh_1").style.animation = "movenn 1s ease-in-out forwards";
              setTimeout(function()
              {
                document.getElementById('Sample11').style.visibility="visible";
                document.getElementById('speed_1').style.visibility="hidden";
                document.getElementById('ndswh_1').style.visibility="hidden";
                document.getElementById('nextButton').style.visibility="visible";
              },2000);
              };
            },1000);
